...
import entityimpl2.monster.MonsterAttributes;
import entityimpl2.monster.MonsterClassBuilder;
import entityimpl2.monster.ai.movement.WanderAI;
...
public interface MovementAI {
     ...
     * @return a {@link MoveResult} representing the result of this move.
     */
    MoveResult move();

    /**
     * Used by {@link MonsterAttributes} to determine if the secondary AI should be used
     * instead of the main movementAI. The secondary AI defaults as {@link WanderAI} in the {@link MonsterClassBuilder}.
